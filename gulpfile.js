...
gulp.task('watch', function() {
	...
	gulp.watch(vars.paths.data.json.src, ['process-json']);
	gulp.watch(vars.paths.html.src, ['process-html']);
});

gulp.task('default', function(done) {
	sequence('process-styles', 'process-scripts', 'process-html', 'process-json', 'process-images', ['localServer','watch'], done);
});
